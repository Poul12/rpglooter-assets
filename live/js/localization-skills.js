...
Object.assign(LANG.en, {
  ...
  perfect_block_dmg_skill_desc: "A perfect block empowers your next attack, increasing its damage by {perfect-dmg}. You seize the moment to unleash a devastating counter.",
  
  perfect_window_skill_name: "Perfect Timing",
  perfect_window_skill_desc: "Increases the reward window for a perfect block by {perfect-window}. Greater precision leads to stronger counters.",
  
  perfect_chain_skill_name: "Counter Chain",
  perfect_chain_skill_desc: "Each consecutive perfect block increases your damage by {chain-dmg}. This effect stacks up to 5 times, rewarding flawless precision.",
...
Object.assign(LANG.pl, {
  ...
  perfect_block_dmg_skill_desc: "Perfekcyjny blok zwiększa obrażenia następnego ataku o {perfect-dmg}. Wykorzystujesz idealny moment, by wyprowadzić niszczycielską kontrę.",

  perfect_window_skill_name: "Precyzyjny Moment",
  perfect_window_skill_desc: "Zwiększa nagrody za perfekcyjny blok o {perfect-window}. Im większa precyzja, tym potężniejsza kontra.",

  perfect_chain_skill_name: "Seria Kontrataków",
  perfect_chain_skill_desc: "Każdy kolejny perfekcyjny blok zwiększa obrażenia o {chain-dmg}. Bonus kumuluje się maksymalnie 5 razy, nagradzając nieprzerwaną precyzję.",
